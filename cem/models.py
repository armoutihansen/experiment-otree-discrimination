...
class Player(BasePlayer):
    ...
    # understanding questions MPL
    # ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    mpl_question_1 = models.IntegerField(
        label="Wenn die Entscheidung D2 zufällig vom Algorithmus als Auszahlungsrelevante Entscheidung ausgewählt wird, dann:",
        choices=[[1, "Erhält der HYPOTHETISCHE TEILNEHMER 0 Punkte"],
                 [2, "Erhält der HYPOTHETISCHE TEILNEHMER 5 Punkte"],
                 [3, "Erhält der HYPOTHETISCHE TEILNEHMER 10 Punkte"],
                 [4, "Der Algorithmus führt die Lotterie aus, bei der der HYPOTHETISCHE TEILNEHMER 100 Punkte mit einer Wahrscheinlichkeit von 50% und 0 Punkte mit einer Wahrscheinlichkeit von 50% erhält"]],
        widget=widgets.RadioSelect)

    mpl_question_2 = models.IntegerField(
        label="Wenn die Entscheidung D19 zufällig vom Algorithmus als Auszahlungsrelevante Entscheidung ausgewählt wird, dann:",
        choices=[[1, "Erhält der HYPOTHETISCHE TEILNEHMER 0 Punkte"],
                 [2, "Erhält der HYPOTHETISCHE TEILNEHMER 90 Punkte"],
                 [3, "Erhält der HYPOTHETISCHE TEILNEHMER 100 Punkte"],
                 [4, "Der Algorithmus führt die Lotterie aus, bei der der HYPOTHETISCHE TEILNEHMER 100 Punkte mit einer Wahrscheinlichkeit von 50% und 0 Punkte mit einer Wahrscheinlichkeit von 50% erhält"]],
        widget=widgets.RadioSelect)
